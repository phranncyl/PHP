        ...
        <div class="row mt">
          <div class="col-md-12">
            ...
            <div class="content-panel">
				<div class="row">
					<div class="col-md-12">
						<a href='cadastrar_bairro.php'><button type="button" class="btn btn-round btn-success"> Novo </button></a> 
					</div>
				</div>
              <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
				  ...
				  <?php
                      ...
                      echo "<td><button class='btn btn-primary btn-xs'><a href='edit_bairro.php?id=" . $row_bairro['id_bairro'] . "' style='color:white;'><i class='fa fa-pencil'></i></a></button>";
                      echo "<button class='btn btn-danger btn-xs'><a href='proc_apagar_bairro.php?id_bairro=" . $row_bairro['id_bairro'] . "' style='color:white;'><i class='fa fa-trash-o'></a></i></button>
